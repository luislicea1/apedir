...
export const lugaresRecomendados = [
  ...
  { nombre: "EL Chinito de Garzon", localizacion: "Santiago de Cuba", numeroPersonas: 20, imagen: imagen3 },
  { nombre: "Club LED", localizacion: "Santiago de Cuba", numeroPersonas: 30, imagen: imagen5 },
