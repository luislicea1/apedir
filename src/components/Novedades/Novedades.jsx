      ...
      <CardHeader className="justify-between" style={{ marginBottom: "10px" }}>
        <div className="flex gap-5" style={{ gap: "15px" }}>
          ...
          <div className="flex flex-col gap-1 items-start justify-center">
            <h4 className="text-small font-semibold leading-none">{novedad.name}</h4>
            <h5 className="text-small tracking-tight text-default-800">{novedad.province}</h5>
          </div>
        </div>
      </CardHeader>

      <CardBody className="px-3 py-0 text-small text-default-800" style={{ marginBottom: "10px" }}>
        <p>
          {novedad.text}
        </p>
      </CardBody>
