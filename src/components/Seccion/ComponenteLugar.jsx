...
function ComponenteLugar({ scrollPosition, ...props }) {
 const [stars, setStars] = useState(null);
 const [imageLoaded, setImageLoaded] = useState(false); // Agrega este estado
...
export default trackWindowScroll(ComponenteLugar);
